import { Home, Building2, Car, Users, FileText, Calendar, HardHat, Euro, FileBox, BarChart2, TrendingUp, Settings, HelpCircle, LifeBuoy } from 'lucide-react';
...
// Voce per i veicoli da aggiungere in futuro
export const VEHICLE_NAV_ITEM: NavItem = {
